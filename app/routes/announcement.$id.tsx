    ...
    <SimpleLayout title="Detail Pengumuman">
      <div className="space-y-4">
        <div className="p-4 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
          <img src={announcement.img} alt={announcement.title} className="w-full h-48 object-cover rounded-lg mb-4" />
          <h1 className="text-xl font-bold mb-2">{announcement.title}</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">{announcement.date}</p>
