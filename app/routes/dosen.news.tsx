...
export function meta() {
  return [{ title: "Berita Dosen - Siakad" }];
}
...
export default function DosenNewsList() {
  // Guard: hanya dosen yang bisa akses
  useEffect(() => {
    try {
  ...
  return (
    <SimpleLayout title="Berita Dosen">
      <div className="mb-3">
