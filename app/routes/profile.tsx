  ...
  return (
    <MobileLayout title="Profil" bgImage="/bg simple.png">
      <div className="p-4 space-y-6">
        ...
        <div className="bg-white  rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 ">Informatika (123456789)</p>
              <p className="text-sm text-gray-500 ">Semester 6</p>
            </div>
            <Link to="/edit-profile" className="p-2 rounded-full bg-gray-100  hover:bg-gray-200  transition-colors" aria-label="Edit profil">
        ...
        {/* Academic Info */}
        <div className="bg-white  rounded-2xl p-6 shadow-sm">
          <h3 className="text-lg font-semibold mb-4 text-gray-900 ">Informasi Akademik</h3>
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              <span className="text-gray-600 ">Status KRS</span>
