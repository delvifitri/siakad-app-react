          ...
          {courses.map((c) => (
            <div key={c.code} className="flex items-center justify-between bg-white rounded-xl p-3 border border-gray-200">
              ...
              <div className="flex gap-2">
                <button className="px-3 py-1 rounded-full text-xs bg-blue-600 text-white">Input Nilai</button>
                <button className="px-3 py-1 rounded-full text-xs bg-emerald-600 text-white">Input Presensi</button>
