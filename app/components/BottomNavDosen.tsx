...
import { HomeIcon, ClipboardDocumentListIcon, AcademicCapIcon, ClipboardDocumentCheckIcon, UserIcon } from "@heroicons/react/24/outline";
...
export default function BottomNavDosen() {
  ...
  { to: "/dosen/bimbingan", label: "Bimbingan TA", icon: <AcademicCapIcon className="w-6 h-6" /> },
